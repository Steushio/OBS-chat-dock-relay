  ...
  startCapture(videoId) {
    ...
    this.chatWindow = new BrowserWindow({
      ...
      webPreferences: {
        ...
        sandbox: true,
        backgroundThrottling: false, // Important to prevent chromium freezing the hidden chat frame
        paintWhenInitiallyHidden: false // Prevent window from showing paint when initially hidden
      }
    });
